...
As part of my statistics and data science courses at Wake Forest University, I teach various hypothesis testing methods. This project aims to apply hypothesis testing from and statistical perspectives. Specifically, we will employ hypothesis testings adopting a reference distribution approach for statistical testing, contingent on whether the data meet normality assumptions.
